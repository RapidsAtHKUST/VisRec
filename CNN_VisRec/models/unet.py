...
class UNetModel(nn.Module):
    ...
    def forward(self, x):
        ...
        # temp = self.out(h).cpu().numpy()
        # plt.imsave(fname=''+str(unn)+'_vis0.png', arr=temp[0][0], cmap="viridis")
        # plt.imsave(fname=''+str(unn)+'_vis1.png', arr=temp[0][1], cmap="viridis")
        # np.save(''+str(unn)+'.npy', temp[0])
        # unn+=1
